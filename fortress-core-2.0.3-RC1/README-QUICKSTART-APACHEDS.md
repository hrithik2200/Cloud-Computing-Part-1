...
# ApacheDS & Fortress QUICKSTART
 ...
 Apache Fortress 2.0.3-RC1-SNAPSHOT and ApacheDS Quickstart System Architecture
 ...
 * This document contains instructions to install Apache Fortress 2.0.3-RC1 Core, Web, Rest and ApacheDS.
...
1. Download and install Apache Directory Server
 ...
 ```
 wget http://www.trieuvan.com/apache//directory/apacheds/dist/2.0.3-M21/apacheds-2.0.3-M21-32bit.bin
 chmod a+x *.bin
 ./apacheds-2.0.3-M21-32bit.bin
 ```

 b. For 64-bit (as sudo or root):

 ```
 wget http://www.trieuvan.com/apache//directory/apacheds/dist/2.0.3-M21/apacheds-2.0.3-M21-64bit.bin
 chmod a+x *.bin
 ./apacheds-2.0.3-M21-64bit.bin
 ```
...
3. Edit ApacheDS conf file
 ...
 ```
 sudo vi /opt/apacheds-2.0.3-M21/conf/wrapper.conf
 ```
...
6. After installation start the directory server process. From system command prompt (as sudo or root):
 ...
 ```
 /etc/init.d/apacheds-2.0.3-M21-default start
 ```
7. Check the status of server process. From system command prompt (as sudo or root):

 ```
 /etc/init.d/apacheds-2.0.3-M21-default status
...
1. Download the package:
 ...
 a. from git:
 ```
 git clone --branch 2.0.3-RC1 https://git-wip-us.apache.org/repos/asf/directory-fortress-core.git
 cd directory-fortress-core
 ```

 b. or download package:
 ```
 wget http://www.apache.org/dist/directory/fortress/dist/2.0.3-RC1/fortress-core-2.0.3-RC1-source-release.zip
 unzip fortress-core-2.0.3-RC1-source-release.zip
 cd fortress-core-2.0.3-RC1
 ```
...
2. Download the fortress realm proxy jar into tomcat/lib folder:
  ...
  ```
  sudo wget http://repo.maven.apache.org/maven2/org/apache/directory/fortress/fortress-realm-proxy/2.0.3-RC1/fortress-realm-proxy-2.0.3-RC1.jar -P /usr/local/tomcat8/lib
  ```
...
1. Download the package:
 ...
 a. from git:
 ```
 git clone --branch 2.0.3-RC1 https://git-wip-us.apache.org/repos/asf/directory-fortress-enmasse.git
 cd directory-fortress-enmasse
 ```

 b. or download package:
 ```
 wget http://www.apache.org/dist/directory/fortress/dist/2.0.3-RC1/fortress-rest-2.0.3-RC1-source-release.zip
 unzip fortress-rest-2.0.3-RC1-source-release.zip
 cd fortress-rest-2.0.3-RC1
 ```
...
1. Download the package:
 ...
 a. from git:
 ```
 git clone --branch 2.0.3-RC1 https://git-wip-us.apache.org/repos/asf/directory-fortress-commander.git
 cd directory-fortress-commander
 ```

 b. or download package:
 ```
 wget http://www.apache.org/dist/directory/fortress/dist/2.0.3-RC1/fortress-web-2.0.3-RC1-source-release.zip
 unzip fortress-web-2.0.3-RC1-source-release.zip
 cd fortress-web-2.0.3-RC1
 ```
